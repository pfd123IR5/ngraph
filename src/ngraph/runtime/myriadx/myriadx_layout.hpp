...
class ngraph::runtime::myriadx::MyriadXLayout : public ngraph::descriptor::layout::TensorLayout
{
public:
    MyriadXLayout(const ngraph::descriptor::Tensor& tv);
    ~MyriadXLayout() override {}
